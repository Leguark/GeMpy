...
class PlotData(object):
    ...
    def plot_data(self, direction="y", **kwargs):
        """
        ...
        plt.quiver(self._data.Foliations[x], self._data.Foliations[y],
                   self._data.Foliations[Gx], self._data.Foliations[Gy],
                   pivot="tail")
    ...
    def plot_potential_field(self, potential_field, cell_number, direction="y", plot_data=True, **kwargs):
